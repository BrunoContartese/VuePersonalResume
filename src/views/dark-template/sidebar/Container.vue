          ...
          items: [
            {
              name: 'Email',
              icon: 'mdi-email',
              text: 'bruno.a.contartese@gmail.com',
            },
            {
              name: 'Website',
              icon: 'mdi-web',
              text: 'brunocontartese.com.ar',
            },
            {
              name: 'Birth Date',
            ...
            },
            {
              name: 'Location',
              icon: 'mdi-map-marker',
              text: 'San Nicolás de los Arroyos, Buenos Aires, Argentina',
            },
          ],
        },
        socials: {
          ...
          items: [
            {
              ...
              text: 'github.com/BrunoContartese',
              link: 'https://github.com/BrunoContartese',
            },
            {
              icon: 'mdi-linkedin-box',
              text: 'linkedin.com/in/bruno-contartese',
              link: 'https://linkedin.com/in/bruno-contartese',
            },
          ],
        },
        hobbies: {
